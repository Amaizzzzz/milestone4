...
public class WeaponStatsBonus {
  ...
  // Constructor
  public WeaponStatsBonus(Item item, Statistic stats, int bonusValue) {
    this.item = item;
    this.stats = stats;
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    WeaponStatsBonus other = (WeaponStatsBonus) obj;
  ...
  public String toString() {
    return String.format(
        "WeaponStatsBonus(itemID=%d, statID=%d, bonusValue=%d)",
